...
//
//     final apiGet = apiGetFromJson(jsonString);

import 'dart:convert';

ApiGet apiGetFromJson(String str) => ApiGet.fromJson(json.decode(str));

String apiGetToJson(ApiGet data) => json.encode(data.toJson());
...
class ApiGet {
  ...
  factory ApiGet.fromJson(Map<String, dynamic> json) => ApiGet(
